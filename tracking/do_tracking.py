...
import os
import sys
sys.path.append('D:/Python_Program/SiamR-CNN-master')
sys.path.append('D:/Python_Program/SiamR-CNN-master/got10k')
sys.path.append('D:/Python_Program/SiamR-CNN-master/tensorpack')
sys.path.append('D:/Python_Program/SiamR-CNN-master/utils')
sys.path.append('D:/Python_Program/SiamR-CNN-master/train_log')
sys.path.append('D:/Python_Program/SiamR-CNN-master/examples')
...
OTB_2015_ROOT_DIR = os.path.join(DATASET_PREFIX, 'D:/Dataset/OTB2015')
...
def build_tracker():
    ...
    # ('--tracklet_distance_threshold', type=float, default=0.06)
    # ('--tracklet_merging_threshold', type=float, default=0.3)
    # ('--tracklet_merging_second_best_relative_threshold', type=float, default=0.3)
    ...
    #('--n_proposals', type=int, default=None)
    ...
    # ('--model', type=str, default="best", help='one of "best", "nohardexamples", or "gotonly"')
    if args.model != "best":
        tracklet_param_str = args.model + "_" + tracklet_param_str

    # ('--visualize_tracker', action='store_true', help='use visualization of tracker (recommended over --visualize_experiment)')
    if args.visualize_tracker:
        tracklet_param_str2 = "viz_" + tracklet_param_str
    else:
        tracklet_param_str2 = tracklet_param_str

    #   ('--ff_gt_score_weight', type=float, default=0.1)
    #   ('--ff_gt_tracklet_score_weight', type=float, default=0.9)
    #   ('--location_score_weight', type=float, default=7.0)
